...
- **dwm-style tagging** - Windows can have multiple tags, views can show multiple tags
- **Tiling layouts** - Vertical stack and monocle (fullscreen) layouts
- **Broadcast mode** - Send input to all visible windows simultaneously
- **Alternate screen buffer** - Proper vim/less/etc restoration on exit
